...
public final class BoardForTen extends Board{
    ...
    protected String createBoard(final List<Jugador> jugadores){
        ...
        sb.append("<td>").append(createSquare(jugadores.get(6).getUsername())).append("</td>");
        ...
        sb.append("</tr>");
        sb.append("<tr>");
        sb.append("<td>").append(createSquare(jugadores.get(7).getUsername())).append("</td>");
        sb.append("<td></td>");
        sb.append("<td></td>");
        sb.append("<td></td>");
        ...
        sb.append("</tr>");
        sb.append("<tr>");
        sb.append("<td>").append(createSquare(jugadores.get(8).getUsername())).append("</td>");
        sb.append("<td></td>");
        sb.append("<td></td>");
        sb.append("<td></td>");
        ...
        sb.append("<tr>");
        sb.append("<td></td>");
        sb.append("<td>").append(createSquare(jugadores.get(9).getUsername())).append("</td>");
